...
// ตรวจว่าเป็นมือถือหรือไม่ — ใช้กำหนดวิธี login Google (mobile ใช้ redirect, desktop ใช้ popup)
function isMobile() {
...
/**
 * หาหน้าที่ควร redirect ไปหลัง login สำเร็จ
 * ถ้าพบ doc ใน collection 'staff' → staff (admin ไป dashboard, ช่าง ไปคิว)
 * ถ้าไม่พบ → ลูกค้าทั่วไป ไปหน้า home
 */
